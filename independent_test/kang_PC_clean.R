...
if(length(args)!=4){
  stop('Rscript Kang_PC_clean <cross_talk/connected_giant> <regions> <pathway1> <pathway2>')
}

print(args)

# Load data #
load('/ysm-gpfs/home/dj333/Project/hongyu/Project/brain/kang.rda')
load('/ysm-gpfs/home/dj333/Project/hongyu/Project/brain/data_all.rda')
load('/ysm-gpfs/home/dj333/Project/hongyu/Project/brain/gene_symbol.rda')
load('/ysm-gpfs/home/dj333/Project/hongyu/Project/brain/brain_regions.rda')
load('/ysm-gpfs/home/dj333/Project/hongyu/Project/brain/time_p.rda')
load('/ysm-gpfs/home/dj333/Project/hongyu/Project/brain/pat_mat.rda')
...
# Kernel Function
kh <- function(h, zi, z) as.numeric(zi == z)
...
fname <- paste(c('Ets', theregion, '_', args[1], args[3], args[4], '.rda'), collapse = '_')
save(Ets, file = fname)